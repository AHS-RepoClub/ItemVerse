...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        itemModelGenerator.register(ModItems.MEDLEY, Models.GENERATED);
        itemModelGenerator.register(ModItems.OMINOUS_TOTEM, Models.GENERATED);
        itemModelGenerator.register(ModItems.BLOOD_SEED, Models.GENERATED);
